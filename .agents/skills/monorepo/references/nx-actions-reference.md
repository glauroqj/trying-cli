...
### Setup PNPM — `Hotmart-Org/actions/nx/setup-pnpm@master`
...
### Setup Nx Cache — `Hotmart-Org/actions/nx/setup-nx-cache@master`
...
### Detect Affected — `Hotmart-Org/actions/nx/detect-affected@master`
...
### Release Version — `Hotmart-Org/actions/nx/release-version@master`
...
### Upload Artifacts — `Hotmart-Org/actions/nx/upload-artifacts@master`
...
### Deploy S3 SPA — `Hotmart-Org/actions/s3/spa/deploy@master`
...
### Deploy S3 Microfrontend — `Hotmart-Org/actions/s3/microfrontend/deploy@master`
...
### CodeArtifact — `Hotmart-Org/actions/codeartifact@master`

Configura `.npmrc` para acesso ao registry privado da Hotmart.
